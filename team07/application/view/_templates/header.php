	   ...
	   <div class="row" id="flex"> 
		...
		<a href="<?php echo URL; ?>proto">Gator Lodge</a>	
	     ...
	     <div class="col-md-4 text-right" id="pills" style="margin-top:3%">
                ...
                <?php  if ($_SESSION['logged_in']){<a  href="<?php echo URL; ?>login_page" class="btn btn-primary btn-lg active" style="background:#330033;" role="button" aria-pressed="true">Log_out</a>} >
